...
//comparable me hm usi class m modified krskte hai
//lekin compartor hmse nayi class bnvaega jha hm sorting likhnege beth k

//1st Way to Use Comparator
//comparable k nadar method hotta hai compareto lekin comparator k andar hotta hai compare jo jake compareto ko call krega
// compareto need only one argument
//compare need two argumemnts
...
//comparable  is used only one type of sort u have.. lekin object bhoot tariko s bnta
//hence  java ne comparable sirf apne lea bnaya hai. vo to hmesha ek hi type ki sort karega (int,float,double string)
// lekin hm bhoot sare tarike s krte hai hence use comparator which use multiple type of sorting.
//our class is made up of multiple data types
{
	private int id;
	private String name;
	...
	public int compareTo(Product p){
		...
		//return this.name.compareToIgnoreCase(p.name); // dictiornary order me
		return p.name.compareToIgnoreCase(this.name);//Deascending order
	}
	// Before Java 5
...
//		Comparator<Product> comp= new Comparator<Product>(){      
		                                                 //anonymous class sb kuch yahi hogya and upcast hora hai comparator me//
//			public int compare(Product one, Product two){
//				return one.getName().compareToIgnoreCase(two.getName());
//			}
//		};
...
//		}
//	});
		                                                                                  //Lemda version sam interface k lea only
